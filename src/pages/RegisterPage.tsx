    ...
    <div className="min-h-screen flex font-sans">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-black via-gray-950 to-red-950">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute right-1/4 bottom-1/4 w-[400px] h-[400px] bg-red-500/10 rounded-full blur-2xl"></div>
        </div>
        {/* Contenido */}
        ...
        <div className="relative z-10 flex flex-col justify-between w-full px-12 py-12">
          <div className="flex-1 flex flex-col justify-center">
            ...
            <p className="text-white/80 text-2xl leading-relaxed max-w-md text-balance">
              Crea tu cuenta y empieza a competir con los mejores predictores de Fórmula 1.
            </p>
          </div>
        </div>
      </div>
      ...
      {/* Sección derecha */}
      <div className="w-full lg:w-1/2 flex lg:items-center justify-center p-8 bg-black overflow-y-auto">
        ...
        <div className="w-full max-w-md py-8">
          <div className="mb-8 text-center">
            ...
            <p className="text-gray-400">
              Únete a la experiencia de predicción F1
            </p>
          </div>
