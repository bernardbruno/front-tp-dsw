              ...
              {[0, 1, 2].map((pos) => (
                <div key={pos} className="mb-3">
                  ...
                  >
                    ...
                    {pilotos.map((piloto) => (
                      <option key={piloto} value={piloto}>
                        {piloto}
                      </option>
                    ))}
                  </select>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-br from-gray-900/90 to-black/90 p-6 rounded-xl border border-red-900/50">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setPredicciones({ ...predicciones, pole: e.target.value })
                  }
                >
                  <option value="">Selecciona un piloto</option>
                  {pilotos.map((piloto) => (
              ...
              <div className="bg-gradient-to-br from-gray-900/90 to-black/90 p-6 rounded-xl border border-red-900/50">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setPredicciones({ ...predicciones, retiro: e.target.value })
                  }
                >
                  <option value="">Selecciona un piloto</option>
                  {pilotos.map((piloto) => (
