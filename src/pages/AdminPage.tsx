        ...
        <>
            <div className="w-screen min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800 overflow-hidden">
                ...
                <div className="relative z-10 container mx-auto px-4 py-12">
                    <div className="text-center mb-10"> {/* Solo contiene al titulo y a la ruedita*/}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto"> {/* Contiene a circuitos, pilotos y escuderias */}
                        <Link to="/circuitos" className="group"> {/* Solo contiene a circuitos */}
                            <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-2xl shadow-2xl border border-red-800/30 hover:scale-105 transition-all duration-300 hover:shadow-red-500/20">
                                <div className="text-center">
                                    ...
                                    <p className="text-gray-400 mb-4">Gestionar pistas</p>
                        ...
                        <Link to="/pilotos" className="group"> {/* Solo contiene a pilotos */}
                            <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-2xl shadow-2xl border border-red-800/30 hover:scale-105 transition-all duration-300 hover:shadow-red-500/20">
                                <div className="text-center">
                                    <div className="w-16 h-16 bg-gradient-to-br from-red-600 to-red-700 rounded-full flex items-center justify-center mx-auto mb-4">
                                        <span className="text-white font-bold text-2xl">👨‍🚀</span>
                        ...
                        <Link to="/escuderias" className="group"> {/* Solo contiene a escuderias */}
                            <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-2xl shadow-2xl border border-red-800/30 hover:scale-105 transition-all duration-300 hover:shadow-red-500/20">
                                <div className="text-center">
                                    <div className="w-16 h-16 bg-gradient-to-br from-red-600 to-red-700 rounded-full flex items-center justify-center mx-auto mb-4">
