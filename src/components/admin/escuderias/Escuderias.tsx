...
export default function Escuderias() {
  ...
  const agregarEscuderia = (nuevaEscuderia) => {
    ...
    setFeedback({
      open: true,
      mensaje: "¡Escuderia agregada correctamente!",
      tipo: "exito",
    });
  };
  ...
  const eliminarEscuderia = (id) => {
    ...
    fetch(`http://localhost:3000/escuderias/${id}`, {
      ...
      .then((response) => {
        ...
        setFeedback({
          open: true,
          mensaje: "¡Escuderia eliminada correctamente!",
          tipo: "exito",
        });
      })
      .catch((error) =>
        console.error("Error al eliminar la escuderia:", error)
      );
  };
  ...
  const editarEscuderia = (escuderiaActualizada) => {
    ...
    setFeedback({
      open: true,
      mensaje: "¡Escuderia editada correctamente!",
      tipo: "exito",
    });
  };
