...
export default function Circuitos() {
    ...
    const agregarCircuito = (nuevoCircuito) => {
        ...
        setFeedback({ open: true, mensaje: "¡Circuito agregado correctamente!", tipo: "exito" }); 
    };
    ...
    const eliminarCircuito = (id) => {
        ...
        fetch(`http://localhost:3000/circuitos/${id}`, { method: 'DELETE' })
            .then(res => {
                ...
                setFeedback({ open: true, mensaje: "¡Circuito eliminado correctamente!", tipo: "exito" });
            })
            .catch(err => {
    ...
    const editarCircuito = (circuitoActualizado) => {
        ...
        setFeedback({ open: true, mensaje: "¡Circuito editado correctamente!", tipo: "exito" });
    };
